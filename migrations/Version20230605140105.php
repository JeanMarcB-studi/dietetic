 ...
 */
final class Version20230605140105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, note NUMERIC(2, 0) NOT NULL, avis LONGTEXT DEFAULT NULL, date_avis DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
